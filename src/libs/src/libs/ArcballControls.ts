        ...
        case STATE.ROTATE:
          if (this.enableRotate) {
            if (restart) {
              ...
              const wq = new Vector3(0, 0, 1)
              const wq1 = new Vector3(1, 0, 0)

              // const cq = new Vector3(this.camera.position.x, this.camera.position.y, this.camera.position.z)
              const cq = new Vector3(
              ...
              console.log(
                'ANGLE',
                wq.angleTo(cq).toFixed(1),
                wq1.angleTo(cq).toFixed(1)
              )
              this.applyTransformMatrix(
                this.rotate(
